...
const dbModel = models.QbSyllabus;
const modelName = 'QbSyllabus';
...
exports.index = (req, res) => {
  ...
  if (req.query._shortcode) {
    filterQuery['_shortcode'] = { [Op.like]: `%${req.query._shortcode}%` };
  }

  if (req.query.includeBoardyears) {
    filterIncludes.push({
      association: models.QbSyllabus.associations['assoc_boardyears'],
