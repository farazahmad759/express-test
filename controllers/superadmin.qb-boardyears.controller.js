...
const dbModel = models.QbBoardyear;
const modelName = 'QbBoardyear';
...
exports.index = (req, res) => {
  ...
  if (req.query.filter__shortcodesArray) {
    filterQuery['_shortcode'] = { [Op.in]: req.query.filter__shortcodesArray };
  }
  if (req.query.includeAssoc_syllabus) {
    filterIncludes.push({
  ...
  dbModel
    ...
    .then((ret) => {
      if (req.body.assoc_syllabus) {
        ret.setAssoc_syllabus(req.body.assoc_syllabus);
      }
      res.send({
        status: 'success',
